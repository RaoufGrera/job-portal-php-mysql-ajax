...
if (!isset	($_POST['explevel_name']) || 
	empty	($_POST["explevel_name"])) {
...
$explevel_name		=	safe_input($_POST['explevel_name']);


$insert_city = $mysqli->query("INSERT INTO `job_exp_type`(`exp_type_name`)
					VALUE ('$explevel_name')"); 
