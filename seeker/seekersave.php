...
if(!isset($_GET['page']))
	...
	$page=(int) $_GET['page'];
			$records_at_page = 20;
			$select_st = "SELECT job_company.comp_id,job_desc_save.desc_id,job_name, domain_name,city_name, comp_name,job_desc,type_name,job_start FROM job_description, job_domain, job_employer, job_company,job_city,job_type,job_status,job_ed_type ,job_nat,job_salary,job_desc_save
			WHERE job_desc_save.desc_id = job_description.desc_id
			...
			AND job_desc_save.seeker_id ='$txt_user_id'
			";
...
$sql ="SELECT job_company.comp_id,job_desc_save.desc_id,image, job_name, domain_name, city_name,comp_active, comp_name,job_desc,type_name,job_start,job_end,DAY(job_end) as job_endd FROM job_description, job_domain, job_employer, job_company,job_city,job_type,job_status,job_ed_type ,job_nat,job_salary,job_desc_save
			WHERE job_desc_save.desc_id = job_description.desc_id
			AND job_employer.emp_id = job_description.emp_id 
			AND job_city.city_id = job_description.city_id
			AND job_employer.comp_id = job_company.comp_id
