<div>
	...
	<div class="modal-body">
		<form  name="form2"  accept-charset="UTF-8"  action="delete_cert.php" method="POST" >
			<span class='delete_text'><?php echo " هل أنت متأكد من حذف شهادة "." ' ". $rows->cert_name." ' "."  ؟"; ?></span> 
			
			<div class ="btninsert">
				<input name="delete_cert" type="submit" value="حفظ" class="btn btn-info"/> 
