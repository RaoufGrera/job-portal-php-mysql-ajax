<div>
	<div class="alert"><strong>أضافة مهارة جديدة</strong></div>
	<?php
	require_once("session.php"); //جلب بيانات الجلسة والكويكز
	require_once("../db/db.php"); // الأتصال بقاعدة البيانات
	?>
	<div class="modal-body">
		<form name="form2"  accept-charset="UTF-8"  action="insert_skilles.php" method="POST" >
			<table class="iteminli" >
				<tr>
					...
					<td>
					<input id="skilles_name" name="skilles_name" type="text"  maxlength="60"  placeholder="اسم المهارة"  />
					</td>
					<td></td>
					<td>
